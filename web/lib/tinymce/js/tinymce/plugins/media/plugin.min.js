                    ...
                    items: [{
                        ...
                        onclick: function() {
                            ...
                            win = e.windowManager.open({
                                ...
                                data: data,
                                classes: 'filemanager',
                                file: '/dialog.php?type=3&editor=' + e.id + '&lang=' + tinymce.settings.language + '&subfolder=' + tinymce.settings.subfolder,
                                filetype: 'video',
                                width: 900,
                                height: 600,
                                inline: 1
                    ...
                    items: [{
                        ...
                        onclick: function() {
                            ...
                            win = e.windowManager.open({
                                ...
                                data: data,
                                classes: 'filemanager',
                                file: '/dialog.php?type=4&editor=' + e.id + '&lang=' + tinymce.settings.language + '&subfolder=' + tinymce.settings.subfolder,
                                filetype: 'video',
                                width: 900,
                                height: 600,
                                inline: 1
                    ...
                    items: [{
                        ...
                        onclick: function() {
                            ...
                            win = e.windowManager.open({
                                ...
                                data: data,
                                classes: 'filemanager',
                                file: '/dialog.php?type=5&editor=' + e.id + '&lang=' + tinymce.settings.language + '&subfolder=' + tinymce.settings.subfolder,
                                filetype: 'video',
                                width: 900,
                                height: 600,
                                inline: 1
